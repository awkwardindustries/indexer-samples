...
public class IndexDocument 
{
    ...
    // Add AnaylzeImage results? Caption + Tags?
    // would be good to demonstrate +analytics capabilities...
    // but that might be built into AzOAI .ChatCompletion API
    // with addition of data source of AI Vision. Definitely
    // would need for SK stuffs if we went that path. I think?!
    ...
    public IndexDocument(OpenDataRecord openDataRecord)
    {
