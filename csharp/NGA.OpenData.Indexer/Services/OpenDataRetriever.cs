...
public class OpenDataRetriever(string connectionString)
{
    private readonly string _connectionString = connectionString;

    public async Task<IEnumerable<OpenDataRecord>> GetAllOpenDataRecords() 
    {
        var records = new List<OpenDataRecord>();
